...
import { IGetMoviesSearch } from '../../api.ts';
import React from 'react';
import { makeImagePath } from '../../utils.ts';
import BigScreenSearchMovie from './BigMovieSearch.tsx';
import BigScreenSearchTv from './BigSeriesSearch.tsx';
                    ...
                    <MovieBox>
                        {data?.results.slice(0, 10).map((data) => (
                            <Poster
                                ...
                                key={data.id}
                                style={{
                                    backgroundImage: `url(${makeImagePath(data.backdrop_path || data.poster_path)})`,
                                }}
